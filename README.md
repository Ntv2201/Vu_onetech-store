...
# 4. Kiểm thử đăng nhập nhanh 6 vai trò & phân quyền RBAC
...
|---|---|---|---|
| **Quản lý** | `admin` | `admin123` | **Toàn quyền**: Dashboard, Bán hàng POS, Đặt trước, Thu - Chi & Sổ quỹ, Bảo hành, Sản phẩm, Quản lý IMEI, Danh mục, Phụ kiện, KH, NCC, Nhân viên. |
...
| **Kế toán** | `ketoan` | `123456` | Dashboard, Thu - Chi & Sổ quỹ, Đặt trước, Tra cứu Hóa đơn, Xem Sản phẩm, Phụ kiện, Khách hàng, Quản lý Nhà cung cấp. |
