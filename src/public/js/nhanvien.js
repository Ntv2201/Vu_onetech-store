        ...
        <tr>
          ...
          <td class="text-end pe-3">
            <div class="d-inline-flex justify-content-end align-items-center" style="gap: 6px;">
              ...
              ${!isCurrentLoggedIn ? `
                <button type="button" class="btn-action ${nv.trangThai === 'Khóa' || nv.trangThai === 'Nghỉ việc' ? 'btn-action-success' : 'btn-action-cancel'}" title="${nv.trangThai === 'Khóa' || nv.trangThai === 'Nghỉ việc' ? 'Mở khóa' : 'Khóa'}" onclick="toggleStatusNhanVien('${nv._id}', '${escapeHtml(nv.hoTen)}', '${nv.trangThai}')">
