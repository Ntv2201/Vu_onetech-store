      ...
      <tr>
        ...
        <td class="text-end pe-3">
          <div class="d-inline-flex justify-content-end align-items-center" style="gap: 6px;">
            ...
            ` : ''}
            ${isManager ? `
              <button type="button" class="btn-action ${kh.status !== false ? 'btn-action-cancel' : 'btn-action-success'}" title="${kh.status !== false ? 'Khóa' : 'Mở khóa'}" onclick="toggleStatusKhachHang('${kh._id}', '${escapeHtml(kh.hoTen)}', ${kh.status !== false})">
