      ...
      <tr>
        ...
        <td class="text-end pe-3">
          <div class="d-inline-flex justify-content-end align-items-center" style="gap: 6px;">
            ...
            ` : ''}
            ${isManager ? `
              <button type="button" class="btn-action ${pk.status !== false ? 'btn-action-cancel' : 'btn-action-success'}" title="${pk.status !== false ? 'Khóa' : 'Mở khóa'}" onclick="toggleStatusPhuKien('${pk._id}', '${escapeHtml(pk.tenPK)}', ${pk.status !== false})">
